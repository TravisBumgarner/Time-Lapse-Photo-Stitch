...
void eButtonBlink(int n){
  for(int i = 1; i<= n; i++){
      digitalWrite(errorButton, HIGH);
      delay(500);
      digitalWrite(errorButton,LOW);
      delay(500);
  }
  delay(2000);
  digitalWrite(errorButton,HIGH);
...
void sButtonBlink(int n){
  for(int i = 1; i<= n; i++){
      digitalWrite(successButton, HIGH);
      delay(500);
      digitalWrite(successButton,LOW);
      delay(500);
  }
  delay(1500);
}
...
void setup()
{
  pinMode(errorButton, OUTPUT);
  pinMode(successButton, OUTPUT);
  uint8_t vid, pid;
  uint8_t temp;
